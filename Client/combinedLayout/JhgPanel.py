...
class JhgPanel(QHBoxLayout):
    def __init__(self, round_state, connection_manager, token_counter, jhg_popularity_plot, jhg_network_graph):
        super().__init__()
        ...
        voting_layout = JhgVotingPanel(round_state, connection_manager, token_counter)  # Create the layout
