"""
So. I accidentally left abstention as an option in this thing. That WASN"T supposed to happen, I don't think?
If it was I don't have it controlled, so thats an ENTIRELY different issue.
There is no such thing as a 0 allocation in JHG, you have to do something
so an abstention is really hare coded
so lets see how much that has been messing up my code.
"""
...
if __name__ == "__main__":
    np.random.seed(42) # just pick a seed.
